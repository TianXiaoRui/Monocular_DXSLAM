...
// todo change Frame constructor 缺少单目初始时提取两倍的特征点的操作 待定
...
//---------------
    void Tracking::MonocularInitialization()
    {
        ...
        else
        {
            ...
            Matcher matcher(0.9,true);//todo delete
            int nmatches = matcher.SearchForInitialization(*mInitialFrame,*mCurrentFrame,mvbPrevMatched,mvIniMatches,100);

            // int nmatches = matcher.SearchForInitialization(*mInitialFrame,*mCurrentFrame,mvIniMatches);
...
bool Tracking::TrackWithMotionModel()
{
    ...
    {
        fill(mCurrentFrame->mvpMapPoints.begin(),mCurrentFrame->mvpMapPoints.end(),static_cast<MapPoint*>(NULL));
        nmatches = matcher.SearchByProjection(*mCurrentFrame,*mLastFrame,10*th,mSensor==System::MONOCULAR);
    }
...
bool Tracking::NeedNewKeyFrame()
{
    ...
    bool bNeedToInsertClose = (nTrackedClose<100) && (nNonTrackedClose>70);//单目直接就是false
